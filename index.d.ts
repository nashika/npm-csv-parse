...
declare function parse(data:string, options:ICsvParseOpts, callback:CsvParseCallbackType):void;
declare function parse(data:string, callback:CsvParseCallbackType):void;
declare function parse(options?:ICsvParseOpts):CsvParser;
declare function parse(dataOrOptions:string|ICsvParseOpts, optionsOrCallback?:ICsvParseOpts|CsvParseCallbackType, callback?:CsvParseCallbackType):void|CsvParser;
